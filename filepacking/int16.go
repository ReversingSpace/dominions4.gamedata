...
// ReadInt16 reads the next int16 (little endian) from the stream.
func ReadInt16(r io.Reader) (value int16, err error) {
	err = binary.Read(r, binary.LittleEndian, &value)
	return
}

// WriteInt16 writes the int16 (little endian) to the stream.
func WriteInt16(w io.Writer, value int16) (err error) {
