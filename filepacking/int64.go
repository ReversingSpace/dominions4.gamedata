...
// ReadInt64 reads the next int64 (little endian) from the stream.
func ReadInt64(r io.Reader) (value int64, err error) {
	err = binary.Read(r, binary.LittleEndian, &value)
	return
}

// WriteInt64 writes the int64 (little endian) to the stream.
func WriteInt64(w io.Writer, value int64) (err error) {
