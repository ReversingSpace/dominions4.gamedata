...
// ReadInt32 reads the next int32 (little endian) from the stream.
func ReadInt32(r io.Reader) (value int32, err error) {
	err = binary.Read(r, binary.LittleEndian, &value)
	return
}

// WriteInt32 writes the int32 (little endian) to the stream.
func WriteInt32(w io.Writer, value int32) (err error) {
